...
function PlayState:enter(params)
    ...
    --get last level width
    self.levelWidth = params.lastLevelWidth


    if self.levelWidth == 0 then --first run only
      self.levelWidth = 100
    else
      self.levelWidth = self.levelWidth + 50 -- make next level longer each time
    end
...
function PlayState:render()
    ...
    love.graphics.print(tostring(self.player.score), 4, 4)--self.player.score
end
