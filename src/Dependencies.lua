...
gSounds = {
    ...
    ['victory-bg'] = love.audio.newSource('sounds/victory-bg.wav', 'static'),
    ['game-over-bg'] = love.audio.newSource('sounds/gameover-bg.wav', 'static')
...
gTextures = {
    ...
    ['jisu'] = love.graphics.newImage('graphics/jisu.png'),
...
gFrames = {
    ...
    ['jisu'] = GenerateQuads(gTextures['jisu'], 16, 20),
